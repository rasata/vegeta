...
func NewMetrics(r Results) *Metrics {
	...
	m.Latencies.P50 = time.Duration(quantileR8(0.50, latencies))
	m.Latencies.P95 = time.Duration(quantileR8(0.95, latencies))
	m.Latencies.P99 = time.Duration(quantileR8(0.99, latencies))
